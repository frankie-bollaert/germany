...
# bw and ni sell their point cloud rather than publishing it, so their downloaders only offer
# dgm1. Read that off the usage line rather than hard-coding a list that would drift as states
# start publishing.
